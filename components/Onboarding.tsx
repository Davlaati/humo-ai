      ...
      case 'Loading':
        return (
           <div className="flex flex-col items-center justify-center h-full relative z-10 animate-fade-in px-8">
             <div className="glass-card w-full max-w-sm p-12 rounded-3xl flex flex-col items-center shadow-2xl backdrop-blur-xl border border-white/20">
               {/* New Book Loader */}
               ...
               <h2 className="text-lg font-medium text-center h-16 flex items-center justify-center transition-all duration-300 text-white/90">
                 {loadingText}
               </h2>

               <div className="w-full bg-slate-700/50 h-1.5 rounded-full overflow-hidden mt-6">
                  <div 
                    className="bg-gradient-to-r from-blue-400 to-purple-400 h-full transition-all duration-100 ease-linear"
