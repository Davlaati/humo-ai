    ...
    <div className="p-5 pb-40 space-y-8 animate-slide-up overflow-x-hidden">
      ...
      <div className="space-y-4">
         ...
         <div className="grid grid-cols-2 gap-3">
            ...
            >
                <div className="absolute top-4 right-4 bg-blue-500 text-white text-[8px] font-black px-2 py-0.5 rounded-full uppercase tracking-widest z-20 shadow-lg animate-pulse">Yangilangan</div>
                <div className="relative z-10 w-2/3">
                    ...
                    <p className="text-slate-400 text-xs font-bold leading-tight">Shaxsiy mentor bilan suhbatlashing va tahlil oling</p>
                    <div className="mt-4 bg-blue-600 w-fit px-4 py-1.5 rounded-full text-[10px] font-black uppercase border border-white/10 shadow-lg">Muloqotni Boshlash</div>
                </div>
