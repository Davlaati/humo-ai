         ...
         <div className="grid grid-cols-2 gap-3">
            ...
            >
                ...
                <div className="relative z-10 w-2/3">
                    ...
                    <h3 className="text-2xl font-black italic text-white uppercase tracking-tighter mb-1">Kutubxona</h3>
                    <p className="text-slate-400 text-xs font-bold leading-tight">Kurslar, podcastlar va kitoblar to'plami</p>
                    <div className="mt-4 bg-blue-600 w-fit px-4 py-1.5 rounded-full text-[10px] font-black uppercase border border-white/10 shadow-lg">O'rganishni Boshlash</div>
                </div>
