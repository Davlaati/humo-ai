      ...
      <div className="space-y-4">
         ...
         <div className="grid grid-cols-2 gap-3">
            ...
            <div 
              ...
              className="col-span-1 glass-card bg-gradient-to-br from-blue-600/20 to-purple-600/20 backdrop-blur-xl border border-blue-500/30 rounded-[35px] p-6 relative h-40 overflow-visible group active:scale-[0.98] transition-all shadow-xl cursor-pointer"
            >
                <div className="absolute top-4 right-4 bg-blue-500 text-white text-[8px] font-black px-2 py-0.5 rounded-full uppercase tracking-widest z-20 shadow-lg animate-pulse">Yangi</div>
                <div className="relative z-10">
                    ...
                    <h3 className="text-lg font-black italic text-white uppercase tracking-tighter mb-1">Kutubxona</h3>
                    <p className="text-slate-400 text-[9px] font-bold leading-tight">Kurslar va kitoblar</p>
                </div>
            </div>
            ...
            <div 
              ...
              className="col-span-1 glass-card bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-xl border border-blue-500/30 rounded-[35px] p-6 relative h-40 overflow-visible group active:scale-[0.98] transition-all shadow-lg cursor-pointer"
            >
                <div className="relative z-10">
                    <div className="w-10 h-10 rounded-full bg-indigo-500/20 flex items-center justify-center mb-3 border border-indigo-500/30">
                        <i className="fa-solid fa-pen-nib text-indigo-400"></i>
                    </div>
                    <h3 className="text-lg font-black italic text-white uppercase tracking-tighter mb-1">Ravona Mock</h3>
                    <p className="text-indigo-300 text-[9px] font-bold leading-tight">Grammar Exam</p>
                </div>
            </div>
